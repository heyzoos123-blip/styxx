...
|---|---|
| cycles logged | **163** |
| preregistrations frozen | **394** (50 carrying a machine-scored gates block) |
...
| gates declaring a power basis | 18 of 50 gated preregs |
| — of those frozen *since* the field existed | **17 of 18** |
...
Certificate verdicts: `OATH-HELD` × 201, `OATH-FAILED` × 7
